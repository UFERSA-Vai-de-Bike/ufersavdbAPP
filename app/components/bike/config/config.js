(function(angular){
    ...
    angular.module('ufersavdb')
        .controller('configBkController', ConfigBkController);
    ConfigBkController.$inject = ['$scope','bikeAPI','$mdToast','$mdDialog'];
    function ConfigBkController($scope,bikeAPI,$mdToast,$mdDialog){
        var vm = this;
        vm.cancel = cancel;
        vm.validBk = validBk;
        vm.upd = upd;
